...
export const categories: Category[] = [
  ...
  { slug: 'metal-anime', name: 'Anime', code: 'MAN', tagline: 'From the frame to your wall.', description: 'Iconic anime moments on brushed aluminium — vivid color, deep blacks, a modern edge.', gradient: ['#3A1C71', '#D76D77'], motif: 'burst', accent: '#D76D77', format: 'metal-poster', image: '/images/metal/anime-image.jpg' },
  { slug: 'metal-movies', name: 'Movies', code: 'MVM', tagline: 'Cinema, framed.', description: 'Cinematic artwork on brushed aluminium — poster-grade color with a metallic sheen.', gradient: ['#0F2027', '#2C5364'], motif: 'film', accent: '#2C5364', format: 'metal-poster', image: '/images/metal/movie-image.jpg' },
  { slug: 'metal-custom', name: 'Custom Prints', code: 'MCU', tagline: 'Your wall, your story.', description: 'Upload your photo or artwork — we print it on brushed aluminium in your chosen size.', gradient: ['#12233A', '#2A3F5E'], motif: 'spark', accent: '#C9A24B', format: 'metal-poster', image: '/images/metal/custom-image.jpg' },
  { slug: 'metal-garage', name: 'Garage', code: 'MGR', tagline: 'STRAIGHT FROM THE GARAGE', description: 'Automotive art on brushed aluminium — speed, design, and the soul of the machine, with a metallic edge.', gradient: ['#1A1A2E', '#E94560'], motif: 'chevron', accent: '#E94560', format: 'metal-poster', image: '/images/metal/garage-image.jpg' },
