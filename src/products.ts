...
const metalSlugs = ['metal-anime', 'metal-movies', 'metal-sports', 'metal-home-decor', 'metal-marvel-dc', 'metal-custom', 'metal-garage'];
...
const rawProducts: Omit<Product, 'id' | 'photos' | 'sizeChartImage' | 'featured'>[] = [
  ...
  p('metal-anime', 'Silent Sakura Metal', 'Petals drift over a quiet village at dusk. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#F472B6', '#831843', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['calm', 'pink', 'village']),
  p('metal-anime', 'Iron Resolve Metal', 'The mecha that stood last on the battlefield. On brushed aluminium, the contrast sharpens into something almost electric.', ['#475569', '#0F172A', '#EF4444'], 'shield', ['a4', 'a3', '16x20'], null, ['mecha', 'red', 'robot']),
  p('metal-anime', 'Moonlit Vow Metal', 'A promise made under a full moon. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#6366F1', '#1E1B4B', '#E0E7FF'], 'leaf', ['a4', 'a3', '16x20'], null, ['night', 'blue']),
  p('metal-anime', 'Ember Eyes Metal', 'The flame that never dies. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#EA580C', '#7F1D1D', '#0C0A09'], 'burst', ['a4', 'a3', '16x20'], null, ['fire', 'demon']),
  p('metal-anime', 'Garden of Echoes Metal', 'Memories in full bloom. On brushed aluminium, the palette turns bold and gallery-bright.', ['#10B981', '#064E3B', '#FCE7F3'], 'leaf', ['a4', 'a3', '16x20'], null, ['soft', 'green']),
  p('metal-anime', 'Steel Heart Metal', 'The knight who chose love over duty. On brushed aluminium, the detail holds a sharp, modern edge.', ['#94A3B8', '#1E293B', '#F87171'], 'shield', ['a4', 'a3', '16x20'], null, ['knight', 'romance']),
  p('metal-anime', 'Phantom Drift Metal', 'A ghost ship sails through clouds rather than water. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#0891B2', '#0E7490', '#E2E8F0'], 'film', ['a4', 'a3', '16x20'], null, ['sea', 'mystery']),
  p('metal-anime', 'Crimson Lotus Metal', 'The bloom after the battle. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#BE123C', '#831843', '#FECDD3'], 'leaf', ['a4', 'a3', '16x20'], null, ['flower', 'red']),
  p('metal-anime', 'Skybound Metal', 'The boy who chased horizons. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#3B82F6', '#1D4ED8', '#FEF9C3'], 'burst', ['a4', 'a3', '16x20'], null, ['sky', 'adventure']),
  p('metal-anime', 'Last Stand Metal', 'The final frame of the war. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#B91C1C', '#450A0A', '#FBBF24'], 'chevron', ['a4', 'a3', '16x20'], null, ['war', 'epic']),
  ...
  p('metal-movies', 'Midnight Express Metal', 'The train that never stops. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#1E40AF', '#0C4A6E', '#E0E7FF'], 'film', ['a4', 'a3', '16x20'], null, ['thriller', 'train']),
  p('metal-movies', 'Golden Hour Heist Metal', 'The last job at sunset. On brushed aluminium, the contrast sharpens into something almost electric.', ['#F59E0B', '#7C2D12', '#111827'], 'film', ['a4', 'a3', '16x20'], null, ['crime', 'sunset']),
  p('metal-movies', 'Frozen Outpost Metal', 'Survival at forty below. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#0EA5E9', '#0C4A6E', '#E0F2FE'], 'shield', ['a4', 'a3', '16x20'], null, ['survival', 'ice']),
  p('metal-movies', 'The Quiet Lake Metal', 'A horror in still water. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#0F766E', '#134E4A', '#A7F3D0'], 'film', ['a4', 'a3', '16x20'], null, ['horror', 'lake']),
  p('metal-movies', 'Velvet Heist Metal', 'A smooth crime in a smooth city. On brushed aluminium, the palette turns bold and gallery-bright.', ['#7E22CE', '#3B0764', '#FBCFE8'], 'film', ['a4', 'a3', '16x20'], null, ['style', 'purple']),
  p('metal-movies', 'Wasteland Riders Metal', 'The road warriors return. On brushed aluminium, the detail holds a sharp, modern edge.', ['#B45309', '#451A03', '#FDE68A'], 'chevron', ['a4', 'a3', '16x20'], null, ['post-apoc', 'cars']),
  p('metal-movies', 'The Last Letter Metal', 'A romance told in postage. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#DC2626', '#7F1D1D', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['romance', 'soft']),
  p('metal-movies', 'Deep Blue Metal', 'The abyss looks back. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#0EA5E9', '#0C4A6E', '#BAE6FD'], 'film', ['a4', 'a3', '16x20'], null, ['deep-sea', 'thriller']),
  p('metal-movies', 'Paper Moon Metal', 'A black-and-white kind of night. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#6B7280', '#1F2937', '#F9FAFB'], 'film', ['a4', 'a3', '16x20'], null, ['classic', 'mono']),
  p('metal-movies', 'Empire of Sand Metal', 'The kingdom the desert swallowed. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#D97706', '#92400E', '#FEF3C7'], 'shield', ['a4', 'a3', '16x20'], null, ['epic', 'desert']),
  ...
  p('metal-custom', 'Pet Portrait (Metal)', 'Your companion, immortalised. On brushed aluminium, the detail holds a sharp, modern edge.', ['#F472B6', '#831843', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['pet', 'portrait']),
  p('metal-custom', 'Family Frame (Metal)', 'Generations on one wall. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#F59E0B', '#7C2D12', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['family', 'portrait']),
  p('metal-custom', 'Wedding Vow (Metal)', 'Your words, our typography. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#BE123C', '#831843', '#FCE7F3'], 'leaf', ['a4', 'a3', '16x20'], null, ['wedding', 'text']),
  p('metal-custom', 'City Skyline (Metal)', 'Your city, our line art. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#1E293B', '#0F172A', '#FBBF24'], 'chevron', ['a4', 'a3', '16x20'], null, ['city', 'line']),
  p('metal-custom', 'Kids\' Doodle (Metal)', 'Your child\'s art, gallery-grade. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#EC4899', '#831843', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['kids', 'fun']),
  p('metal-custom', 'Quote Wall (Metal)', 'A sentence that stays with you. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#1E1B4B', '#0F172A', '#FDE68A'], 'spark', ['a4', 'a3', '16x20'], null, ['quote', 'text']),
  p('metal-custom', 'Map of Memory (Metal)', 'A place that means everything. On brushed aluminium, the contrast sharpens into something almost electric.', ['#0EA5E9', '#0C4A6E', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['map', 'place']),
  p('metal-custom', 'Logo Plate (Metal)', 'Your brand, metal-grade. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#A07E2F', '#7A5E22', '#1E1B4B'], 'shield', ['a4', 'a3', '16x20'], null, ['brand', 'logo']),
  p('metal-custom', 'Song Lyric (Metal)', 'The line you can\'t stop singing. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#7E22CE', '#3B0764', '#FBCFE8'], 'spark', ['a4', 'a3', '16x20'], null, ['music', 'text']),
  p('metal-custom', 'Anniversary Date (Metal)', 'A number that changed everything. On brushed aluminium, the palette turns bold and gallery-bright.', ['#DC2626', '#7F1D1D', '#FECDD3'], 'spark', ['a4', 'a3', '16x20'], null, ['date', 'love']),
  p('metal-custom', 'Recipe Plate (Metal)', 'Grandma\'s recipe, preserved. On brushed aluminium, the detail holds a sharp, modern edge.', ['#16A34A', '#14532D', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['food', 'text']),
  p('metal-custom', 'Constellation Map (Metal)', 'The sky the night you were born. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#1E1B4B', '#0F172A', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['stars', 'night']),
  ...
  p('metal-garage', 'Desert Rally Metal', 'Dust, gravel, and pure horsepower. On brushed aluminium, the detail holds a sharp, modern edge.', ['#F59E0B', '#92400E', '#FEF3C7'], 'chevron', ['a4', 'a3', '16x20'], null, ['rally', 'desert', 'orange']),
  p('metal-garage', 'Garage Days Metal', 'A workshop, a wrench, a dream. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#92400E', '#451A03', '#FEF3C7'], 'film', ['a4', 'a3', '16x20'], null, ['garage', 'warm', 'classic']),
  p('metal-garage', 'Lowrider Sunset Metal', 'Chrome and candy paint at golden hour. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#7C3AED', '#4C1D95', '#FBBF24'], 'burst', ['a4', 'a3', '16x20'], null, ['lowrider', 'purple', 'sunset']),
  p('metal-garage', 'Electric Silence Metal', 'The future moves without a sound. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#0EA5E9', '#E0F2FE', '#94A3B8'], 'shield', ['a4', 'a3', '16x20'], null, ['ev', 'blue', 'future']),
  p('metal-garage', 'Classic Coupe Metal', 'Timeless lines, timeless curves. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#166534', '#14532D', '#FCD34D'], 'film', ['a4', 'a3', '16x20'], null, ['classic', 'green', 'vintage']),
  p('metal-garage', 'Pit Stop Metal', 'Four seconds, four tyres. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#F59E0B', '#0F172A', '#DC2626'], 'burst', ['a4', 'a3', '16x20'], null, ['f1', 'amber', 'precision']),
  p('metal-garage', 'Road Trip Metal', 'The highway that goes forever. On brushed aluminium, the contrast sharpens into something almost electric.', ['#1E40AF', '#F59E0B', '#FBCFE8'], 'film', ['a4', 'a3', '16x20'], null, ['road', 'blue', 'sunset']),
  p('metal-garage', 'Street Racer Metal', 'Two lanes, one winner. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#DC2626', '#1E40AF', '#0F172A'], 'chevron', ['a4', 'a3', '16x20'], null, ['street', 'red', 'night']),
  p('metal-garage', 'Convertible Coast Metal', 'Top down, ocean side. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#0D9488', '#134E4A', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['convertible', 'teal', 'coast']),
  p('metal-garage', 'Truck Legend Metal', 'Built tough, built to last. On brushed aluminium, the palette turns bold and gallery-bright.', ['#92400E', '#166534', '#F59E0B'], 'shield', ['a4', 'a3', '16x20'], null, ['truck', 'brown', 'rugged']),

  // ---- METAL POSTER: SPORTS ----
  p('metal-sports', 'The Bicycle Kick Metal', 'Defying gravity, defining the game. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#F59E0B', '#7C2D12', '#0F172A'], 'chevron', ['a4', 'a3', '16x20'], null, ['football', 'iconic']),
  p('metal-sports', 'Last Second Shot Metal', 'The buzzer-beater that echoed. On brushed aluminium, the contrast sharpens into something almost electric.', ['#DC2626', '#7F1D1D', '#FBBF24'], 'burst', ['a4', 'a3', '16x20'], null, ['basketball', 'clutch']),
  p('metal-sports', 'The Cover Drive Metal', 'Elegance in willow and leather. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#0EA5E9', '#0C4A6E', '#FDE68A'], 'chevron', ['a4', 'a3', '16x20'], null, ['cricket', 'classic']),
  p('metal-sports', 'Knockout Punch Metal', 'The fist that changed history. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#B91C1C', '#450A0A', '#FCD34D'], 'burst', ['a4', 'a3', '16x20'], null, ['boxing', 'power']),
  p('metal-sports', 'The Long Drive Metal', 'Fairway to glory. On brushed aluminium, the palette turns bold and gallery-bright.', ['#10B981', '#064E3B', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['golf', 'green']),
  p('metal-sports', 'Sprint Finish Metal', 'The line that decided gold. On brushed aluminium, the detail holds a sharp, modern edge.', ['#F59E0B', '#92400E', '#0F172A'], 'chevron', ['a4', 'a3', '16x20'], null, ['athletics', 'speed']),
  p('metal-sports', 'The Slam Dunk Metal', 'Above the rim, above the rest. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#7C3AED', '#4C1D95', '#FDE047'], 'burst', ['a4', 'a3', '16x20'], null, ['basketball', 'power']),
  p('metal-sports', 'Goalkeeper\'s Dive Metal', 'The save that stopped time. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#0EA5E9', '#0C4A6E', '#FBBF24'], 'shield', ['a4', 'a3', '16x20'], null, ['football', 'defense']),
  p('metal-sports', 'The Serve Metal', 'An ace under the sun. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#F97316', '#7C2D12', '#FEF3C7'], 'burst', ['a4', 'a3', '16x20'], null, ['tennis', 'precision']),
  p('metal-sports', 'Corner Flag Metal', 'The celebration that shook the stadium. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#16A34A', '#14532D', '#FBBF24'], 'chevron', ['a4', 'a3', '16x20'], null, ['football', 'joy']),
  p('metal-sports', 'The Knockout Combo Metal', 'Two hits, one ending. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#DC2626', '#7F1D1D', '#0F172A'], 'burst', ['a4', 'a3', '16x20'], null, ['boxing', 'combo']),
  p('metal-sports', 'Wicket Celebration Metal', 'The roar after the wicket. On brushed aluminium, the contrast sharpens into something almost electric.', ['#0D9488', '#134E4A', '#FDE68A'], 'chevron', ['a4', 'a3', '16x20'], null, ['cricket', 'fire']),
  p('metal-sports', 'The Header Metal', 'Airborne, unstoppable. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#1D4ED8', '#1E3A8A', '#FDE047'], 'burst', ['a4', 'a3', '16x20'], null, ['football', 'air']),
  p('metal-sports', 'Final Lap Metal', 'The last curve before glory. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#EA580C', '#7C2D12', '#0F172A'], 'chevron', ['a4', 'a3', '16x20'], null, ['racing', 'final']),
  p('metal-sports', 'The Free Kick Metal', 'Bending it beyond reach. On brushed aluminium, the palette turns bold and gallery-bright.', ['#0EA5E9', '#0C4A6E', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['football', 'curve']),

  // ---- METAL POSTER: HOME DECOR ----
  p('metal-home-decor', 'Monstera Morning Metal', 'Light through living leaves. On brushed aluminium, the detail holds a sharp, modern edge.', ['#10B981', '#064E3B', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['botanical', 'green']),
  p('metal-home-decor', 'Desert Lines Metal', 'Minimalist dunes at dusk. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#D97706', '#92400E', '#FEF3C7'], 'chevron', ['a4', 'a3', '16x20'], null, ['abstract', 'warm']),
  p('metal-home-decor', 'Ocean Calm Metal', 'A still sea, a still mind. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#0EA5E9', '#0C4A6E', '#E0F2FE'], 'leaf', ['a4', 'a3', '16x20'], null, ['calm', 'blue']),
  p('metal-home-decor', 'Terrazzo Dream Metal', 'A modern speckled composition. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#EC4899', '#831843', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['abstract', 'pink']),
  p('metal-home-decor', 'Line Face Metal', 'One-line portrait, endless feeling. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#1E293B', '#0F172A', '#F8FAFC'], 'leaf', ['a4', 'a3', '16x20'], null, ['line-art', 'mono']),
  p('metal-home-decor', 'Sunset Arch Metal', 'Architecture in golden hour. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#F59E0B', '#7C2D12', '#FEF3C7'], 'chevron', ['a4', 'a3', '16x20'], null, ['arch', 'warm']),
  p('metal-home-decor', 'Bloom No. 7 Metal', 'A single flower, fully seen. On brushed aluminium, the contrast sharpens into something almost electric.', ['#BE185D', '#831843', '#FCE7F3'], 'leaf', ['a4', 'a3', '16x20'], null, ['floral', 'pink']),
  p('metal-home-decor', 'Mist over Pines Metal', 'A forest waking up. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#0D9488', '#134E4A', '#F0FDFA'], 'leaf', ['a4', 'a3', '16x20'], null, ['forest', 'teal']),
  p('metal-home-decor', 'Brass Geometry Metal', 'Warm metallic shapes on dark. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#A07E2F', '#7A5E22', '#1E1B4B'], 'burst', ['a4', 'a3', '16x20'], null, ['geometric', 'brass']),
  p('metal-home-decor', 'Wave Study Metal', 'A Hokusai-inspired modern swell. On brushed aluminium, the palette turns bold and gallery-bright.', ['#0EA5E9', '#0C4A6E', '#FDE68A'], 'leaf', ['a4', 'a3', '16x20'], null, ['wave', 'blue']),
  p('metal-home-decor', 'Coffee & Sun Metal', 'A slow morning, framed. On brushed aluminium, the detail holds a sharp, modern edge.', ['#92400E', '#451A03', '#FEF3C7'], 'leaf', ['a4', 'a3', '16x20'], null, ['cozy', 'brown']),
  p('metal-home-decor', 'Marble Vein Metal', 'Luxury in a single swirl. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#94A3B8', '#475569', '#F8FAFC'], 'leaf', ['a4', 'a3', '16x20'], null, ['luxury', 'stone']),
  p('metal-home-decor', 'Citrus Pop Metal', 'A bright kitchen accent. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#F97316', '#7C2D12', '#FEF3C7'], 'burst', ['a4', 'a3', '16x20'], null, ['kitchen', 'orange']),
  p('metal-home-decor', 'Mountain Range Metal', 'A minimalist horizon line. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#475569', '#1E293B', '#FDE68A'], 'chevron', ['a4', 'a3', '16x20'], null, ['landscape', 'mono']),
  p('metal-home-decor', 'Golden Hour Metal', 'The last light, the best light. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#F59E0B', '#B45309', '#FECDD3'], 'burst', ['a4', 'a3', '16x20'], null, ['sky', 'warm']),

  // ---- METAL POSTER: MARVEL / DC ----
  p('metal-marvel-dc', 'Web Slinger Metal', 'The hero in the half-light. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#DC2626', '#7F1D1D', '#1E3A8A'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'red']),
  p('metal-marvel-dc', 'Thunder God Metal', 'A hammer raised to the storm. On brushed aluminium, the contrast sharpens into something almost electric.', ['#3B82F6', '#1E3A8A', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'thunder']),
  p('metal-marvel-dc', 'Iron Resolve Metal', 'A suit built for sacrifice. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#EA580C', '#7C2D12', '#FCD34D'], 'shield', ['a4', 'a3', '16x20'], null, ['hero', 'gold']),
  p('metal-marvel-dc', 'Night Knight Metal', 'The dark defender rises. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#1E293B', '#0F172A', '#FBBF24'], 'shield', ['a4', 'a3', '16x20'], null, ['hero', 'dark']),
  p('metal-marvel-dc', 'Shield Throw Metal', 'The spin that won the war. On brushed aluminium, the palette turns bold and gallery-bright.', ['#1D4ED8', '#1E3A8A', '#DC2626'], 'shield', ['a4', 'a3', '16x20'], null, ['hero', 'shield']),
  p('metal-marvel-dc', 'Green Rage Metal', 'A smash heard round the world. On brushed aluminium, the detail holds a sharp, modern edge.', ['#16A34A', '#14532D', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'green']),
  p('metal-marvel-dc', 'Speed Force Metal', 'The lightning in his veins. On brushed aluminium, the color deepens into a rich, reflective finish.', ['#F59E0B', '#92400E', '#1E3A8A'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'speed']),
  p('metal-marvel-dc', 'Cape in Wind Metal', 'The man who chose hope. On brushed aluminium, the scene gains a sleek, contemporary polish.', ['#1D4ED8', '#1E3A8A', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'hope']),
  p('metal-marvel-dc', 'Lasso of Truth Metal', 'The warrior princess. On brushed aluminium, the highlights take on a bright, almost luminous quality.', ['#A855F7', '#581C87', '#FBCFE8'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'purple']),
  p('metal-marvel-dc', 'Trident Rise Metal', 'The king of the seas. On brushed aluminium, the whole piece reads sharper, more vivid, more alive.', ['#0EA5E9', '#0C4A6E', '#FDE68A'], 'shield', ['a4', 'a3', '16x20'], null, ['hero', 'sea']),
  p('metal-marvel-dc', 'Claws Out Metal', 'The mutant who walks alone. On brushed aluminium, the colors gain a vivid, reflective intensity that paper can\'t match.', ['#FDE047', '#A16207', '#1E293B'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'yellow']),
  p('metal-marvel-dc', 'Cosmic Surf Metal', 'Riding the edge of space. On brushed aluminium, the contrast sharpens into something almost electric.', ['#6366F1', '#312E81', '#FDE68A'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'cosmic']),
  p('metal-marvel-dc', 'Bat Signal Metal', 'A call answered in the dark. On brushed aluminium, the tones take on a cool, metallic sheen.', ['#1E1B4B', '#0F172A', '#FBBF24'], 'shield', ['a4', 'a3', '16x20'], null, ['hero', 'night']),
  p('metal-marvel-dc', 'Thunder Strike Metal', 'A storm named after a god. On brushed aluminium, every highlight gets a crisp, high-contrast edge.', ['#3B82F6', '#1E3A8A', '#FCD34D'], 'burst', ['a4', 'a3', '16x20'], null, ['hero', 'storm']),
  p('metal-marvel-dc', 'The Assemble Metal', 'Six heroes, one frame. On brushed aluminium, the palette turns bold and gallery-bright.', ['#DC2626', '#1D4ED8', '#FDE68A'], 'shield', ['a4', 'a3', '16x20'], null, ['team', 'epic']),
